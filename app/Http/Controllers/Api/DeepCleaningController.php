...
class DeepCleaningController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->successResponse($deepCleanings);
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->createdResponse($deepCleaning->load(['chalet', 'cleaner']), 'تم إنشاء عملية التنظيف العميق بنجاح');
    }
    ...
    public function show(DeepCleaning $deepCleaning)
    {
        ...
        return $this->successResponse($deepCleaning);
    }
    ...
    public function update(Request $request, DeepCleaning $deepCleaning)
    {
        ...
        return $this->updatedResponse($deepCleaning->fresh(['chalet', 'cleaner']), 'تم تحديث عملية التنظيف العميق بنجاح');
    }
