...
class DamageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->createdResponse($damage->load(['chalet', 'cleaner']), 'تم إنشاء تقرير الضرر بنجاح');
    }
    ...
    public function update(Request $request, Damage $damage)
    {
        ...
        return $this->updatedResponse($damage->fresh(['chalet', 'cleaner']), 'تم تحديث تقرير الضرر بنجاح');
    }
