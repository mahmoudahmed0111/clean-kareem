...
class RegularCleaningController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->successResponse($regularCleanings);
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->createdResponse($regularCleaning->load(['chalet', 'cleaner']), 'تم إنشاء عملية التنظيف العادي بنجاح');
    }
    ...
    public function show(RegularCleaning $regularCleaning)
    {
        ...
        return $this->successResponse($regularCleaning);
    }
    ...
    public function update(Request $request, RegularCleaning $regularCleaning)
    {
        ...
        return $this->updatedResponse($regularCleaning->fresh(['chalet', 'cleaner']), 'تم تحديث عملية التنظيف العادي بنجاح');
    }
    ...
    public function uploadImages(Request $request, RegularCleaning $regularCleaning)
    {
        ...
        return $this->successResponse($uploadedImages, 'تم رفع الصور بنجاح');
    }
    ...
    public function uploadVideos(Request $request, RegularCleaning $regularCleaning)
    {
        ...
        return $this->successResponse($uploadedVideos, 'تم رفع الفيديوهات بنجاح');
    }
}
