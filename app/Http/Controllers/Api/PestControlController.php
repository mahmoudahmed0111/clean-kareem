...
class PestControlController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->successResponse($pestControls);
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->createdResponse($pestControl->load(['chalet', 'cleaner']), 'تم إنشاء عملية مكافحة الآفات بنجاح');
    }
    ...
    public function show(PestControl $pestControl)
    {
        ...
        return $this->successResponse($pestControl);
    }
    ...
    public function update(Request $request, PestControl $pestControl)
    {
        ...
        return $this->updatedResponse($pestControl->fresh(['chalet', 'cleaner']), 'تم تحديث عملية مكافحة الآفات بنجاح');
    }
