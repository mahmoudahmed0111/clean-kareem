...
class MaintenanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->createdResponse($maintenance->load(['chalet', 'cleaner']), 'تم إنشاء عملية الصيانة بنجاح');
    }
    ...
    public function update(Request $request, Maintenance $maintenance)
    {
        ...
        return $this->updatedResponse($maintenance->fresh(['chalet', 'cleaner']), 'تم تحديث عملية الصيانة بنجاح');
    }
